        ...
        <div className="flex items-center gap-2 sm:gap-4 lg:gap-8 py-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            >
              <h1 className="text-xl md:text-2xl font-extrabold tracking-tight text-slate-900">
                Rocks<span className="text-blue-600">Mart</span>
              </h1>
            </Link>
          </div>
          ...
          >
            <Input
              ...
              className="rounded-r-none border-r-0 border-slate-300 focus-visible:ring-2 focus-visible:ring-blue-600 h-10"
              aria-label="Search products"
            />
            <Button
              type="submit"
              className="rounded-l-none bg-blue-600 hover:bg-blue-700 px-5 h-10"
