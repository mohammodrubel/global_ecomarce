      ...
      <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-10">
        ...
        >
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-24 border-slate-200 shadow-lg overflow-hidden rounded-2xl">
              <div className="bg-gradient-to-r from-[#1C398E] to-blue-700 text-white p-5 sm:p-6">
